...
class HotelRoomController extends Controller
{
    ...
    {
        $detail_room = DB::select("SELECT hotel_room.id, hotel_room.nomor, tipe_room.tipe, tipe_room.harga, tipe_room.deskripsi, tipe_room.kapasitas, tipe_room.imageurl FROM hotel_room join tipe_room on hotel_room.tipe_id=tipe_room.id WHERE hotel_room.id=?",[$id]);
        $response = new \stdClass();
        $response->tanggal = Carbon::now()->toDateString();
